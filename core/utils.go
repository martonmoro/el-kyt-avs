...
// this hardcodes abi.encode() for cstaskmanager.IKYTTaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.IKYTTaskManagerTaskResponse) ([]byte, error) {

	// The order here has to match the field ordering of cstaskmanager.IKYTTaskManagerTaskResponse
...
func GetTaskResponseDigest(h *cstaskmanager.IKYTTaskManagerTaskResponse) ([32]byte, error) {

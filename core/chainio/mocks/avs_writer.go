...
// Source: github.com/martonmoro/incredible-squaring-avs/core/chainio (interfaces: AvsWriterer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_writer.go -package=mocks github.com/martonmoro/incredible-squaring-avs/core/chainio AvsWriterer
//
...
import (
	...
	contractIncredibleSquaringTaskManager "github.com/martonmoro/incredible-squaring-avs/contracts/bindings/IncredibleSquaringTaskManager"
...
func (m *MockAvsWriterer) RaiseChallenge(arg0 context.Context, arg1 contractIncredibleSquaringTaskManager.IKYTTaskManagerTask, arg2 contractIncredibleSquaringTaskManager.IKYTTaskManagerTaskResponse, arg3 contractIncredibleSquaringTaskManager.IKYTTaskManagerTaskResponseMetadata, arg4 []contractIncredibleSquaringTaskManager.BN254G1Point) (*types.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendAggregatedResponse(arg0 context.Context, arg1 contractIncredibleSquaringTaskManager.IKYTTaskManagerTask, arg2 contractIncredibleSquaringTaskManager.IKYTTaskManagerTaskResponse, arg3 contractIncredibleSquaringTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (*types.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendNewTaskNumberToSquare(arg0 context.Context, arg1 *big.Int, arg2 uint32, arg3 []byte) (contractIncredibleSquaringTaskManager.IKYTTaskManagerTask, uint32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendNewTaskNumberToSquare", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(contractIncredibleSquaringTaskManager.IKYTTaskManagerTask)
	ret1, _ := ret[1].(uint32)
	ret2, _ := ret[2].(error)

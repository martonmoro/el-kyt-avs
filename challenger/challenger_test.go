...
import (
	...
	"github.com/martonmoro/incredible-squaring-avs/challenger/mocks"
	chtypes "github.com/martonmoro/incredible-squaring-avs/challenger/types"
...
func TestCallChallengeModule(t *testing.T) {
	...
	challenger.tasks[TASK_INDEX] = cstaskmanager.IKYTTaskManagerTask{

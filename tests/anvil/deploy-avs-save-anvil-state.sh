...
anvil --port 8546 --load-state eigenlayer-deployed-anvil-state.json --dump-state avs-and-eigenlayer-deployed-anvil-state.json &
cd ../../contracts
forge script script/KYTDeployer.s.sol --rpc-url $RPC_URL --private-key $PRIVATE_KEY --broadcast -v
...
jq '.number = "'$(cast block-number --rpc-url $RPC_URL)'"' $GENESIS_FILE > $TMP_GENESIS_FILE
...
cast send --rpc-url $RPC_URL 0x860B6912C2d0337ef05bbC89b0C2CB6CbAEAB4A5 --value 10ether --private-key 0x2a871d0798f97d79848a013d4936a73bf4cc922c825d33c1cf7073dff6d409c6
